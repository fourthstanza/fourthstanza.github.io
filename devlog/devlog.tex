...
Manual implementation of language switching button in the navbar. Implemented by switching between two versions of each page. Static elements not handled by the router have built-in language switching by analyzing the URL and changing which text is displayed based on the language prefix.
