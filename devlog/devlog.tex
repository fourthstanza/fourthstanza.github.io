...
\begin{enumerate}
    ...
    \item In @/src/sections/gallery.tsx, \begin{itemize} \item Add the new GalImages component to the images array \item Add new english and french titles to the galleryTitles arrays \item Add new english and french paragraphs tohe galleryParagraphs arrays \item add the new gallery to the pages array \end{itemize}
\end{enumerate}
