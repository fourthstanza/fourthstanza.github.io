...
\href{https://lucide.dev/}{Lucide-react} is installed for icons. \href{https://tailwindcss.com}{TailwindCSS} is used for inline CSS. See installation instructions for a project with Vite+React \href{https://tailwindcss.com/docs/installation/using-vite}{here}.
...
\subsection{Adding images to existing gallery}
...
\subsection {Adding a new gallery}

To add a new gallery, do the following:

\begin{enumerate}
    \item Add a new gallery folder to the @/src/assets/images/ folder, and populate.
    \item Add a new galImages component in @/src/sections/Galleries, and copy over the code, while changing relevant sections.
    \item Add a new gallery component in @/src/sections/Galleries, and copy over the code, while changing relevant sections.
    \item In @/src/sections/gallery.tsx, \begin{itemize} \item add the new gallery to the pages array \item Import the corresponding GalImages component \item Add the new GalImages component to the images array \item Add new english and french titles to the galleryTitles arrays \item Add new english and french paragraphs tohe galleryParagraphs arrays \end{itemize}
    \item In @/src/sections/sections/galleryPages.tsx, import and add the new Gallery pages to the pages record
\end{enumerate}
